...
public class Test {
    ...
    private Integer testQuestionsum;
    ...
    @Transient
    private Integer testState;   //试卷状态，0待考 1正在考试中 2考试已结束 3该用户已经答过该卷
    ...
    public Integer getTestQuestionsum() {
        return testQuestionsum;
    }

    public void setTestQuestionsum(Integer testQuestionsum) {
        this.testQuestionsum = testQuestionsum;
    }
