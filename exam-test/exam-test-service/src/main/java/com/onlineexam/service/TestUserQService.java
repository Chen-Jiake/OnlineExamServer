...
public class TestUserQService {
     ...
     * @return
     */
    public PageResult<TestUserQ> findTestUserQsByPage(Integer page, Integer rows, Long fkTestGradeId, Long fkQuestionSubjectId) {
        ...
        for(TestUserQ t : list){
            ...
            if(fkTestGradeId != null && fkQuestionSubjectId == null){
                if(t.getFkTest().getFkTestGradeId() == fkTestGradeId){
                    list1.add(t);
                }
            }else if(fkTestGradeId == null && fkQuestionSubjectId != null){
                if(t.getFkTest().getFkTestSubjectId() == fkQuestionSubjectId){
                    list1.add(t);
                }
            }else if(fkTestGradeId != null && fkQuestionSubjectId != null){
                if(t.getFkTest().getFkTestGradeId() == fkTestGradeId && t.getFkTest().getFkTestSubjectId() == fkQuestionSubjectId){
                    list1.add(t);
                }
            }else{
                list1.add(t);
